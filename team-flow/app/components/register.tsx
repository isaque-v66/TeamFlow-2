...
const registerData = z.object({
    ...
    password: z.string().min(5, 'A senha deve ter pelo menos 5 caracteres').max(50)
})

type SchemaRegisterData = z.infer<typeof registerData>

export function RegisterPage() {
    const [loading, setLoading] = useState(false)
    const { register, handleSubmit, formState: { errors }, reset } = useForm<SchemaRegisterData>({
        resolver: zodResolver(registerData)
    })

    async function useHandle(data: SchemaRegisterData) {
        setLoading(true)
            ...
            <div className="min-h-screen grid lg:grid-cols-2">
                ...
                <div className="flex items-center justify-center p-8">
                    <div className="w-full max-w-md space-y-8">
                        ...
                        <div className="space-y-2">
                            <h1 className="text-3xl font-semibold tracking-tight text-balance">Crie sua conta!</h1>
                            <p className="text-muted-foreground text-pretty">
                                Registre-se para começar a gerenciar os projetos da sua equipe.
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div className="flex items-center justify-center p-8 bg-muted/50">
                    <div className="w-full max-w-md">
                        ...
                        <CardContent>
                            <form onSubmit={handleSubmit(useHandle)} className="space-y-6">
                                {/* Campo Email */}
                                <div className="space-y-2">
